...
> <a id='ref7' style="text-decoration: none; color: inherit;"> REFACTORING GURU. *Abstract Factory*. Disponível em: [https://refactoring.guru/pt-br/design-patterns/abstract-factory](https://refactoring.guru/pt-br/design-patterns/abstract-factory). Acesso em: 22 maio 2025.</a>
...
| `1.2`  | 22/05/2025 | Adicionando as imagens geradas no .puml e a especificação de cada elementos do AbstractFactory e Ajustes Finais| [Víctor Schmidt](https://github.com/moonshinerd) | | |
| `1.3`  | 22/05/2025 | Corrigindo alguns erros e adicionando bibliografia | [Víctor Schmidt](https://github.com/moonshinerd) | | |