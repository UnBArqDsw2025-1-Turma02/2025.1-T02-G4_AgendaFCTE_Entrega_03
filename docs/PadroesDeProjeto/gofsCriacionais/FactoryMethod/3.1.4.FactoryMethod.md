...
Add aqui a introdução falando o que é o artefato (adicionar bibliografia tambem).

## Metodologia

Add como foi feito e explicar o que é o factory method. No código as funcionalidade escolhida foi de criar eventos de diferentes tipos e listar-los.
...
| `1.1`  | 30/05/2025 | Adição do diagrama, código e como rodar     | [Victor Bernardes](https://github.com/VHbernardes) |  |  | 